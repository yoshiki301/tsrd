...
dataset <- generate_scenario(
  sim_num = 1L,
  IcMc_size = 50L, ItMc_size = 50L, IcMt_size = 50L, ItMt_size = 50L
)
...
test_that("estimate_boot_ci_sequentially works", {
  boot_ci <- estimate_boot_ci_sequentially(multiple_dataset, boot_num = 5L, alpha = 0.05, verbose = FALSE)
